...
function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (dataToSend.age !== undefined && dataToSend.age !== '') {
      dataToSend.age = Number(dataToSend.age);
      if (isNaN(dataToSend.age)) {
        ...
        if (dataToSend.age === '' || dataToSend.age === undefined) {
            delete dataToSend.age;
        }
    }
    console.log("Data being sent to backend for registration:", dataToSend);
